    ...
    <div className="w-full block z-50 fixed bg-white top-0 dark:bg-dark-second">
      <div className="w-full flex px-2 my-1">
        <div className="w-1/2 flex ml-1 md:w-1/4 relative">
          <div
            className="w-11/12 dark:bg-dark-second bg-gray-200 absolute -top-1 -left-3 flex z-30 hidden
          flex-wrap shadow-lg"
          >
                ...
                <div className="relative bg-gray-100 dark:bg-dark-third px-2 py-2 w-11 h-11 lg:w-10 xl:w-max xl:pl-3 xl:pr-8 rounded-full flex items-center justify-center cursor-pointer">
                  <input
                    ...
                    className="w-56 outline-none 
                          bg-transparent hidden xl:inline-block dark:text-white"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="w-1/2 hidden md:block md:w-2/4 lg:w-1/2">
          <div className="mx-auto wrapper xl:w-4/5 md:w-full">
            <ul className="list-icon-header md:w-full">
              <li className="active dark:hover:bg-dark-third w-1/5 xl:w-auto">
                <svg
                  viewBox="0 0 28 28"
              ...
              <li className="dark:hover:bg-dark-third w-1/5 xl:w-auto">
                <svg
                  viewBox="0 0 28 28"
        ...
        <div className="w-1/2 flex sm:w-3/4 md:w-1/4">
          ...
          >
            <ul className="w-full hidden">
              ...
              <li
                className="w-full flex p-3 cursor-pointer dark:hover:bg-dark-third  dark:text-white 
                  font-semibold hover:bg-gray-200"
              >
                &nbsp; &nbsp;&nbsp;
                <i className="fas fa-cog text-xl dark:text-white"></i>
                &nbsp; &nbsp; &nbsp;Cài Đặt Tài Khoản
              </li>
              <li
                className="w-full flex p-3 cursor-pointer dark:hover:bg-dark-third hover:bg-gray-200 
                  dark:text-white font-semibold"
              >
                &nbsp; &nbsp;&nbsp;
                <i className="fas fa-sign-out-alt text-xl dark:text-white"></i>
                &nbsp; &nbsp; &nbsp;Đăng Xuất
              </li>
            </ul>
          </div>
